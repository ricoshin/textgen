...
class Network(object):
    def __init__(self, cfg, corpus, vocab, vocab_pos=None):
        ...
        # Optimizers
        self.optim_embed = optim.SGD(self.embed.parameters(), lr=cfg.lr_ae)
        self.optim_enc = optim.SGD(self.enc.parameters(), lr=cfg.lr_ae) # default: 1
        self.optim_dec = optim.SGD(self.dec.parameters(), lr=cfg.lr_ae) # default: 1
        self.optim_gen_s = optim.Adam(self.dec.parameters(),
        ...
        self.optim_disc_c = optim.Adam(self.disc_c.parameters(),
                                       ...
                                       betas=(cfg.beta1, 0.999))
        self.optim_disc_d = optim.Adam(self.disc_d.parameters(),
                                       lr=cfg.lr_gan_d, # default: 0.00001
                                       betas=(cfg.beta1, 0.999))
        self.optim_disc_g = optim.Adam(self.disc_g.parameters(),
                                       lr=cfg.lr_gan_d, # default: 0.00001
                                       betas=(cfg.beta1, 0.999))
